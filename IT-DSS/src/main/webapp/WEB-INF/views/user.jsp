...
<div class="row">
						<div class="col-md-6 form-group">
							<label class="col-md-4 control-label" for="issue-ticket">Fault
								Event Date</label>
							<div class="col-md-8">
								<input type="text" id="faultEventDate" class="form-control" />
							</div>
						</div>
					</div>

</body>
<script type="text/javascript" src="resources/js/customDateTime/customTime.js">
</script>
</html>